...
using MicroServicoEstoque.DTOs;
...
namespace MicroServicoEstoque.Service
{
    public class ProdutoService
    {
        ...
        private readonly VendaClient _vendaClient;

        public ProdutoService(ProdutoRepository produtoRepository, IIAService iaService, VendaClient vendaClient)
        {
